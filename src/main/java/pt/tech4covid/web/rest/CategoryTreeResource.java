...
public class CategoryTreeResource {
    ...
    public ResponseEntity<List<CategoryTree>> getAllCategoryTrees(CategoryTreeCriteria criteria, Pageable pageable) {
        log.debug("REST request to get CategoryTrees by criteria: {}", criteria);
        Page<CategoryTree> page = categoryTreeQueryService.findByCriteria(criteria, pageable);
