...
public class ArticleTypeResource {
    ...
    public ResponseEntity<ArticleType> createArticleType(@RequestBody ArticleType articleType) throws URISyntaxException {
    ...
    public ResponseEntity<ArticleType> updateArticleType(@RequestBody ArticleType articleType) throws URISyntaxException {
    ...
    public ResponseEntity<List<ArticleType>> getAllArticleTypes(Pageable pageable) {
        log.debug("REST request to get a page of ArticleTypes");
        Page<ArticleType> page = articleTypeService.findAll(pageable);
